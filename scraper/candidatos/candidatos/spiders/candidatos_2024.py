...
class Candidatos2024Spider(Spider):
    ...
    def parse_bens(self, response):
        data = json.loads(response.text)
        dados_candidato = response.meta["dados_candidato"]
        
        # TODO: adicionar os dados importantes daqui (doadores, gastos, etc)
        # https://divulgacandcontas.tse.jus.br/divulga/rest/v1/prestador/consulta/2045202024/2024/81051/11/45/45/240002149850
        # em dados_candidato e retornar com yield